...
import React, { useEffect, useState, useRef } from 'react';
import videoSrc from '../assets/acron.mp4'; // Import the video
import imageSrc from '../assets/bg4.png'; // Import an example image
      ...
      <div className="relative bg-black text-white p-8 w-full lg:w-[60%] flex flex-col justify-start shadow-lg rounded-lg m-4 lg:m-8">
        ...
        <div className="space-y-8">
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col lg:flex-row lg:space-x-8">
              <div className="mb-4 lg:mb-0">
                <p className="text-6xl font-bold text-orange-600">{fundingCount}M+</p>
                <p className="text-lg">In funding raised by our clients.</p>
              </div>
              <div>
                <p className="text-6xl font-bold text-orange-600">{awardsCount}+</p>
                <p className="text-lg">International awards won.</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            <blockquote className="text-lg italic border-l-4 border-orange-600 pl-4">
              “Lazarev fostered a positive engagement by delivering a navigable site that allowed users to absorb information quickly.”
            </blockquote>
            <p className="text-xl font-semibold">BOYD HOBBS</p>
            <p className="text-sm">PRESIDENT & OWNER, NODO FILM SYSTEMS</p>
          ...
          <form className="space-y-4 text-[1vw]">
            <div className="relative">
              <input
                type="text"
                placeholder="Your Name *"
                className="w-full p-2 border-b-2 border-white bg-transparent text-white focus:outline-none focus:border-orange-500 focus:placeholder-opacity-100 placeholder-opacity-50"
              />
            </div>
            <div className="relative">
              <input
            ...
            <div className="relative">
              <textarea
                placeholder="Project Details *"
                className="w-full p-2 border-b-2 border-white bg-transparent text-white focus:outline-none focus:border-orange-500 focus:placeholder-opacity-100 placeholder-opacity-50 h-32 resize-none"
              ></textarea>
            </div>
            <button
              type="submit"
              className="w-full p-3 rounded-3xl bg-orange-600 text-white rounded hover:bg-orange-600 transition-colors"
            >
              Explain Project Idea
            </button>
          </form>
